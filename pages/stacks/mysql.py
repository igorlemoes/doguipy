...
def deploy_mysql(modal, default_id=None, default_image=None, default_name=None, default_domain=None, default_port=None, default_envs=None):
        ...
        var_port        = default_port if default_port else 3306
        var_envs        = envs
        var_volumes     = [(var_name+"_mysql_data","/var/lib/mysql")]
...
def form_mysql() -> None:
    ...
    default_envs = """MYSQL_DATABASE=banco_dados_usuario
MYSQL_USER=mysql_usuario
MYSQL_PASSWORD=mysql_usuario_senha
MYSQL_ROOT_PASSWORD=mysql_root_senha"""
    ...
    with container_fields:
        fields.get_fields(template_deploy='mysql', default_image=default_image, default_envs=default_envs)
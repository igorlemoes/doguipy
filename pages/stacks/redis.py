...
def deploy_redis(modal, default_id=None, default_image=None, default_name=None, default_domain=None, default_port=None, default_envs=None):
        ...
        var_port        = default_port if default_port else 6379
        var_envs        = envs
        var_volumes     = [(var_name+"_redis_data","/data")]
...
def form_redis() -> None:
    ...
    with container_fields:
        fields.get_fields(template_deploy='redis', default_image=default_image, default_envs=default_envs)
...
def deploy_pgadmin(modal, default_id=None, default_image=None, default_name=None, default_domain=None, default_port=None, default_envs=None):
...
@ui.page('/form/pgadmin')
def form_pgadmin() -> None:
    ...
    default_image = 'dpage/pgadmin4:latest'
    
    default_envs = """PGADMIN_DEFAULT_EMAIL=seuemail@email.com
PGADMIN_DEFAULT_PASSWORD=senha"""
    ...
    with container_fields:
        fields.get_fields(template_deploy='pgadmin', default_image=default_image, default_envs=default_envs)
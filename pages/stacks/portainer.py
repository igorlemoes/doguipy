...
def deploy_portainer(modal, default_id=None, default_image=None, default_name=None, default_domain=None, default_port=None, default_envs=None):
...
@ui.page('/form/portainer')
def form_portainer() -> None:
    ...
    default_image = 'portainer/portainer-ce:latest'
    ...
    with container_fields:
        fields.get_fields(template_deploy='portainer', default_image=default_image, default_envs=default_envs)